 ...
 * @author Steve Brown
 *
 * Find how many days sick leave an employee has had for a year.
 */
@RequiredArgsConstructor
public class FindEmployeeSickLeave implements StrategyEmployeeAttendanceRecord{
	...
	public long getDaysAbsentForYear() {
		...
		return empAbsentRepo.numDaysEmployeeHasBeenAbsent(attYear, "Sick", empId);
	}
}
